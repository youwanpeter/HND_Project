...
<html lang="en-US">
	...
	<body class="home home-video">
		...
		<div class="video-container">
			<video id="video" class="video" preload="metadata" playsinline="" autoplay="" muted="" loop="" >
				<source src="https://matchthemes.com/demowp/gleam/wp-content/uploads/gleam-video.mp4" type="video/mp4">
			</video>
			<div class="slider-caption">
				<div class="slider-text">
					<h1 class="display-2">Tilia Photography Studio</h1>
					<p>Cum et labore appareat, te est nostrum eligendi adipisci. Tota quas habeo eu vel. Vel autem apeirian primis.</p>
					<a href="#" class="read-more white-btn">Find More</a>
				</div>
			</div>
		</div>
		<!-- /HOME VIDEO -->
		...
		<div id="wrap-content" class="page-content custom-page-template">
			<!-- SECTION 1 -->
			<div id="home-section-video-1" class="section-holder home-section-video-1">
				<div class="container">
					<div class="row">
						<div class="col-lg-6 margin-bm50">
							<div class="margin-r50">
								<div class="el-smalltitle">Tilia Studio</div>
								<h2 class="display-4 margin-b30">We're a Team of Creatives Ready to Capture Your Event</h2>
								<p>Veri ubique cu eam, vero dicta ridens ei quo, ex putent menandri accommodare sed. Suscipit lobortis prodesset ut eam. Sale dicta dolore pri et, an aliquam.</p>
						...
						<!-- /col-lg-6 -->	
						<div class="col-lg-3">
							<div class="icon-holder margin-b30">
							...
							<div class="icon-holder margin-bm30">
								...
								<!-- /icon-svg -->
								<h5 class="margin-b10">02. Portraits</h5>
								<p>Est sale definitiones id. Ut quo quem harum munere, eu labore voluptatum mei.</p>
							</div>
							<!-- /icon-holder -->
						</div>
						...
						<div class="col-lg-3">
							<div class="icon-holder margin-b30">
								...
								<!-- /icon-svg -->
								<h5 class="margin-b10">03. Fashion</h5>
								<p>Est sale definitiones id. Ut quo quem harum munere, eu labore voluptatum mei.</p>
							</div>
							<!-- /icon-holder -->
							<div class="icon-holder">
								<div class="icon-svg margin-b10">
									<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 74 74" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
										<g>
											<g xmlns="http://www.w3.org/2000/svg">
												<path d="m16.68 16.9c1.63 0 2.95-1.32 2.95-2.95s-1.32-2.95-2.95-2.95-2.95 1.32-2.95 2.95 1.32 2.95 2.95 2.95zm0-4.9c1.07 0 1.95.87 1.95 1.95 0 1.07-.87 1.95-1.95 1.95-1.07 0-1.95-.87-1.95-1.95 0-1.07.87-1.95 1.95-1.95z" class=""></path>
												<path d="m12.53 19.93c.24-.75.17-1.55-.2-2.25-.36-.7-.98-1.21-1.73-1.45s-1.55-.17-2.25.2c-.7.36-1.21.98-1.45 1.73-.49 1.55.38 3.21 1.92 3.7.31.09.61.14.9.14 1.25 0 2.42-.81 2.81-2.07zm-4.66-1.47c.16-.5.5-.9.96-1.14.28-.15.59-.22.9-.22.2 0 .39.03.59.09.5.16.9.5 1.14.96s.29.99.13 1.49-.5.9-.96 1.14-.99.29-1.48.13c-1.04-.33-1.61-1.42-1.28-2.45z" class=""></path>
												<path d="m14.19 24.8c-1.33-.93-3.17-.61-4.11.72-.45.64-.63 1.43-.49 2.2.14.78.57 1.45 1.21 1.9.51.36 1.1.53 1.69.53.93 0 1.85-.44 2.42-1.26.93-1.32.61-3.16-.72-4.09zm-.1 3.53c-.62.88-1.83 1.09-2.71.48-.43-.3-.71-.75-.8-1.26s.02-1.03.32-1.46c.38-.54.98-.83 1.6-.83.39 0 .78.11 1.11.35.88.62 1.1 1.84.48 2.72z" class=""></path>
23c0 3.92-1.99 7.47-5.32 9.54h-11.8c-3.34-2.06-5.33-5.61-5.33-9.54zm45.14 39.79c0 1.63-1.33 2.96-2.96 2.96h-39.12c-1.63 0-2.96-1.33-2.96-2.96v-26.29c0-1.63 1.33-2.96 2.96-2.96h39.12c1.63 0 2.96 1.33 2.96 2.96zm1-21.39h4.19v16.48h-4.19zm16.96 20.68c0 .54-.44.99-.99.99h-3.14v-26.85h3.14c.54 0 .99.44.99.99z" class=""></path>
											</g>
										</g>
									</svg>
								</div>
								<!-- /icon-svg -->
								<h5 class="margin-b10">04. Video</h5>
								<p>Est sale definitiones id. Ut quo quem harum munere, eu labore voluptatum mei.</p>
							</div>
							<!-- /icon-holder -->
						</div>
			...
			<!-- /SECTION 1 -->	
			<!-- SECTION 2 -->
			<div id="home-section-video-2" class="section-holder home-section-video-2">
				<div id="portfolio-nomargin" class="portfolio-grid-container portfolio-grid-container-v2">
			...
			<!-- /SECTION 2 -->	
			<!-- SECTION 3 -->
			<div id="home-section-video-3" class="section-holder section-info margin-notop100 padding-tb100 home-section-video-3">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 margin-bm50">
							<div class="margin-r50">
								<div class="el-smalltitle">Recognition</div>
								<h2 class="display-4 margin-b30">Awards Winning Photograhy and Videography Studio</h2>
							</div>
							<!-- /margin-r50 -->	
						</div>
						<!-- /col-lg-6 -->	
						<div class="col-lg-6">
							<div class="row">
								<div class="col-4">
									<img class="img-fluid" src="images/home/awards-1.png" alt=" " />
								</div>
								<!-- /col-4 -->
								<div class="col-4">
									<img class="img-fluid" src="images/home/awards-2.png" alt=" " />
								</div>
								<!-- /col-4 -->
								<div class="col-4">
									<img class="img-fluid" src="images/home/awards-3.png" alt=" " />
								</div>
								<!-- /col-4 -->
							</div>
							<!-- /row -->
					...
					<div class="row margin-t50">
						<div class="col-lg-6 margin-bm50">
							<img class="img-fluid radius10" src="images/portfolio/featured-images/gal-6-masonry.jpg" alt=" " />
						</div>
						<!-- /col-lg-6 -->
						<div class="col-lg-6">
								...
								<ul class="faq-list">
									<li>
										...
										<div id="faq1" class="faq-section">
											<p>Te essent lobortis mea. Fugit dolores no ius, te simul ancillae voluptatibus sea. Magna nullam ad mei. Et quo partem euismod, an ornatus impedit nam, ad quaeque aliquam pro. No usu mutat inimicus consetetur, et nostro labitur voluptatibus sea. Eum vidit scripta voluptaria ad, in cum dictas perpetua. Democritum repudiandae in nec, vel eu deleniti neglegentur.</p>
										</div>
									</li>
									<li>
										...
										<div id="faq2" class="faq-section">
											<p>Sea et quodsi minimum intellegebat, eirmod lobortis at his. Pri eu melius nostrud, magna euripidis duo in, evertitur prodesset quaerendum ei pri. Vel pertinax quaerendum ut, id esse quas partiendo mea. Porro putant aliquam eu mel. Sit cu voluptaria elaboraret, at affert iudicabit pro, su harum saperet debitis ex.</p>
										</div>
									</li>
									<li>
										...
										<div id="faq3" class="faq-section">
											<p>Cum ea meliore eleifend, mel dolores prodesset eu. Zril tollit mandamus pro et, eos ei feugiat labores explicari. Ius ut quis sumo soluta, sea viris scribentur ei. Cum nisl oblique vulputate ex, eos cu wisi petentium. Feugiat hendrerit in mel, in dico reque adversarium ius.</p>
										</div>
									</li>
								</ul>
							</div>
			...
			<!-- SECTION 4 -->
			<div id="home-section-1-7" class="section-holder home-section-1-7 section-nomargin parallax" style="background-image:url(images/pages/portfolio1-page.jpg);">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="padding-lr200 alignc">
								...
								<p>Te vis veniam detracto, tollit alterum graecis his ut. At pro essent aliquip qualisque, vis splendide posidonium ex.</p>
