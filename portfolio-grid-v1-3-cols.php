...
<html lang="en-US">
	<head>
		...
		<title>Portfolio Grid v1 3 Cols - Tilia </title>
		<!-- Google Fonts -->
								...
								while($row = mysqli_fetch_assoc($query_run))
								{
									...
									<div class="item-portfolio item-3cols wedding">
												<div class="post-image item-grid-image">
													<img loading="lazy" src="admin/uploaded_img/<?php echo $row['image']?>" class="img-fluid" alt=" " width="750" height="750">
													 <a class="cursor-eye" href="#"> </a>
													</div>
											</div> 
