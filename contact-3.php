...
<html lang="en-US">
	...
	<body class="home">
		...
		<div id="wrap-content" class="page-content custom-page-template">
			<!-- SECTION 1 -->
			<div id="contact-3-1" class="section-holder contact-3-1">
				<div class="container">
					<div class="row">
						<div class="col-lg-6 margin-bm50">
							<div class="margin-r50">
								<h2 class="display-4 margin-b30">Let's Talk. Get in Touch</h2>
								<p>Lorem ipsum dolor sit amet, eam ex velit postea repudiare, est sale definitiones id. Ut quo quem harum munere, eu labore voluptatum mei, ad epicurei interesset has.</p>
							</div>
						</div>
						<!-- /col-lg-6 -->
						<div class="col-lg-6">
			...
			<!-- /SECTION 1 -->
			<!-- SECTION 2 -->
			<div id="contact-3-2" class="contact-3-2">
				<div class="container">
					<div class="row g-0">
						<div class="col-lg-6">
							<img class="img-fluid" src="images/portfolio/gal-grid/gal-grid-04.jpg" alt="" />
						</div>
						<!-- /col-lg-6 -->
